...
const columns = [
  ...
  {name: "ORDER TOTAL", uid: "total", sortable: true},
...
const INITIAL_VISIBLE_COLUMNS = ["name","orderDate" , "total" , "role", "status", "actions"];
        ...
        return (
          <div className="relative font-poppins flex justify-end items-center gap-2">
            <Dropdown className="bg-background border-1 border-default-200">
              ...
              <DropdownMenu>
                <DropdownItem><NavLink to={`/singleproduct/${user.id}`}>View</NavLink></DropdownItem>
